...
description: Azure Remote Rendering is a service that enables you to render high-quality, interactive 3D content in the cloud and stream it in real time to devices, such as the HoloLens 2.
author: sima-zhu
ms.author: sizhu
ms.date: 02/23/2021
ms.topic: reference
...
- Learn about the runtime SDKs:
  - .NET: [Remote rendering](https://docs.microsoft.com/dotnet/api/microsoft.azure.remoterendering)
  - C++: [Remote rendering](https://docs.microsoft.com/cpp/api/remote-rendering)
