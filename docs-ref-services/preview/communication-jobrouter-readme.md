...
keywords: Azure, java, SDK, API, azure-communication-jobrouter, communication/azure-communication-jobrouter
ms.date: 05/17/2025
ms.topic: reference
ms.devlang: java
ms.service: communication/azure-communication-jobrouter
---
# Azure Communication Job Router client library for Java - version 2.0.0-alpha.20250516.2 
