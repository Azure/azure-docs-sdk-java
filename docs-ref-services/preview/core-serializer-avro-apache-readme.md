...
# Azure Core Apache Avro Serializer plugin library for Java - Version 1.0.0-beta.17 
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-serializer-avro-apache_1.0.0-beta.17/CONTRIBUTING.md).
