...
ms.service: core
---
# Azure Core Vert.x HTTP plugin library for Java - version 1.0.0-beta.12 
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-http-vertx_1.0.0-beta.12/CONTRIBUTING.md).
