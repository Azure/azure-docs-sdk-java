...
description: Azure Data Lake Storage is Microsoft's optimized storage solution for for big
...
To learn more about the BOM, see the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-storage-file-datalake_12.8.0-beta.3/sdk/boms/azure-sdk-bom/README.md).
