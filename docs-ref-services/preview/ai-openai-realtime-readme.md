---
title: Azure OpenAI Realtime client library for Java
keywords: Azure, java, SDK, API, azure-ai-openai-realtime, openai
ms.date: 12/06/2024
ms.topic: reference
ms.devlang: java
ms.service: openai
---
# Azure OpenAI Realtime client library for Java - version 1.0.0-alpha.20241205.3 
 (experimental)
