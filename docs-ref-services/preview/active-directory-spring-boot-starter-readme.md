...
ms.technology: azure
ms.devlang: java
ms.service: azureactivedirectory
---

# Azure AD Spring Boot Starter client library for Java - Version 2.3.5 
...
![Single Page Application + Spring Boot Web API + Azure AD](https://github.com/Azure/azure-sdk-for-java/raw/88a365dc93871e5954d0fce0c96a642866ab13d8/sdk/spring/azure-spring-boot-starter-active-directory/resource/auth-in-frontend-with-aad-filter.png)
...
![Single Page Application + Spring Boot Web API + Azure AD](https://github.com/Azure/azure-sdk-for-java/raw/88a365dc93871e5954d0fce0c96a642866ab13d8/sdk/spring/azure-spring-boot-starter-active-directory/resource/auth-in-backend-code-mode.png)

#### ID Token mode usage(Stateless implicit)

![Single Page Application + Spring Boot Web API + Azure AD](https://github.com/Azure/azure-sdk-for-java/raw/88a365dc93871e5954d0fce0c96a642866ab13d8/sdk/spring/azure-spring-boot-starter-active-directory/resource/auth-in-backend-id-token-mode.png)
...
Please refer to [azure-spring-boot-sample-active-directory-backend](https://github.com/Azure/azure-sdk-for-java/tree/88a365dc93871e5954d0fce0c96a642866ab13d8/sdk/spring/azure-spring-boot-samples/azure-spring-boot-sample-active-directory-backend/README.md) for authenticate in backend. Or [azure-spring-boot-sample-active-directory-backend-v2](https://github.com/Azure/azure-sdk-for-java/tree/88a365dc93871e5954d0fce0c96a642866ab13d8/sdk/spring/azure-spring-boot-samples/azure-spring-boot-sample-active-directory-backend-v2/README.md) to use Microsoft Graph API instead of Azure Active Directory Graph API.
...
Please refer to [azure-active-directory-spring-boot-sample](https://github.com/Azure/azure-sdk-for-java/tree/88a365dc93871e5954d0fce0c96a642866ab13d8/sdk/spring/azure-spring-boot-samples/azure-spring-boot-sample-active-directory/README.md) for how to integrate Spring Security and Azure AD for authentication and authorization in a Single Page Application (SPA) scenario.
...
Please refer to [azure-spring-boot-sample-active-directory-backend-v2](https://github.com/Azure/azure-sdk-for-java/tree/88a365dc93871e5954d0fce0c96a642866ab13d8/sdk/spring/azure-spring-boot-samples/azure-spring-boot-sample-active-directory-backend-v2/README.md) to see a sample configured to use the Microsoft Graph API.
...
### More sample code
- [Azure Active Directory for Frontend](https://github.com/Azure/azure-sdk-for-java/tree/88a365dc93871e5954d0fce0c96a642866ab13d8/sdk/spring/azure-spring-boot-samples/azure-spring-boot-sample-active-directory)
- [Azure Active Directory for Backend](https://github.com/Azure/azure-sdk-for-java/tree/88a365dc93871e5954d0fce0c96a642866ab13d8/sdk/spring/azure-spring-boot-samples/azure-spring-boot-sample-active-directory-backend)
- [Azure Active Directory for Backend with Microsoft Graph API](https://github.com/Azure/azure-sdk-for-java/tree/88a365dc93871e5954d0fce0c96a642866ab13d8/sdk/spring/azure-spring-boot-samples/azure-spring-boot-sample-active-directory-backend-v2)

## Contributing
This project welcomes contributions and suggestions.  Most contributions require you to agree to a Contributor License Agreement (CLA) declaring that you have the right to, and actually do, grant us the rights to use your contribution. For details, visit https://cla.microsoft.com.

Please follow [instructions here](https://github.com/Azure/azure-sdk-for-java/tree/88a365dc93871e5954d0fce0c96a642866ab13d8/sdk/spring/CONTRIBUTING.md) to build from source or contribute.
...
[sample]: https://github.com/Azure/azure-sdk-for-java/tree/azure-active-directory-spring-boot-starter_2.3.5/sdk/spring/azure-spring-boot-samples
