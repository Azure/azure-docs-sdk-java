...
ms.service: core
---
# Azure Core Experimental shared library for Java - Version 1.0.0-beta.29 
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-experimental_1.0.0-beta.29/CONTRIBUTING.md).
