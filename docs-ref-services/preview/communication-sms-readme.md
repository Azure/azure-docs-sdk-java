...
keywords: Azure, java, SDK, API, azure-communication-sms, communication/azure-communication-sms
ms.date: 05/19/2025
ms.topic: reference
ms.devlang: java
ms.service: communication/azure-communication-sms
---
# Azure Communications SMS Service client library for Java - version 1.2.0-alpha.20250519.1 
