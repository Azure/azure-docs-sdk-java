...
ms.service: cosmos
---
# Azure Cosmos DB Client Library for Java - version 4.53.2-hotfix 
...
To learn more about the BOM, see the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-cosmos_4.53.2-hotfix/sdk/boms/azure-sdk-bom/README.md).
