...
description: Azure Web PubSub service is an Azure-managed service that helps developers easily build web applications with real-time features and publish-subscribe pattern.
author: sima-zhu
ms.author: sizhu
ms.date: 11/11/2021
ms.topic: reference
