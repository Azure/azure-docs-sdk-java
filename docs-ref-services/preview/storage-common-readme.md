...
ms.service: storage
---
# Azure Storage Common shared library for Java - Version 12.15.0-beta.3 
...
To learn more about the BOM, see the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-storage-common_12.15.0-beta.3/sdk/boms/azure-sdk-bom/README.md).
