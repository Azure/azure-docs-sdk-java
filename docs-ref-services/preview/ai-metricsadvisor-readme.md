...
description: Reference for Azure Metrics Advisor client library for Java.
...
* [Configure an anomaly alert configuration](#configure-anomaly-alert-configuration "#configure-an-anomaly-alert-configuration")
