...
# Azure Monitor query client library for Java - Version 1.0.0-beta.3 
...
BatchQuery logsBatchQuery = new LogsBatchQuery()
...
BatchQueryResultCollection batchResultCollection = logsQueryClient
.queryBatchWithResponse(logsBatchQuery, Context.NONE).getValue();

<LogsBatchQueryResult> responses = batchResultCollection.getBatchResults();

(LogsBatchQueryResult response : responses) {
...
<!-- embedme ./src/samples/java/com/azure/monitor/query/ReadmeSamples.java#L226-L230 -->
```java
...
[source_code]: https://github.com/Azure/azure-sdk-for-java/tree/azure-monitor-query_1.0.0-beta.3/sdk/monitor/azure-monitor-query/src

[samples_readme]: https://github.com/Azure/azure-sdk-for-java/blob/azure-monitor-query_1.0.0-beta.3/sdk/monitor/azure-monitor-query/src/samples/java/README.md
...
[log_levels]: https://github.com/Azure/azure-sdk-for-java/blob/azure-monitor-query_1.0.0-beta.3/sdk/core/azure-core/src/main/java/com/azure/core/util/logging/ClientLogger.java
