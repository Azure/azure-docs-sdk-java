---
title: Azure Key Vault Certificates client library for Java
...
1. Build and install the [Azure Key Vault JCA client library for Java](https://github.com/Azure/azure-sdk-for-java/blob/azure-spring-boot-starter-keyvault-certificates_3.0.0-beta.2/sdk/keyvault/azure-security-keyvault-jca/README.md)
...
# Azure Key Vault Certificates client library for Java - Version 3.0.0-beta.2 
