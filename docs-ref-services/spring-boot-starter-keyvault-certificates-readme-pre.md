---
title: Azure KeyVault Certificates client library for Java
keywords: Azure, java, SDK, API, azure-spring-boot-starter-keyvault-certificates, 
author: maggiepint
ms.author: magpint
ms.date: 10/21/2020
ms.topic: article
...
# Azure KeyVault Certificates client library for Java - Version 3.0.0-beta.1 
