...
keywords: Azure, java, SDK, API, azure-security-keyvault-jca, security
author: maggiepint
ms.author: magpint
ms.date: 11/18/2020
ms.topic: article
...
# Azure Key Vault JCA client library for Java - Version 1.0.0-beta.2 
...
For Spring Boot applications see our [Spring Boot starter](https://github.com/Azure/azure-sdk-for-java/blob/azure-security-keyvault-jca_1.0.0-beta.2/sdk/spring/azure-spring-boot-starter-keyvault-certificates/README.md).
