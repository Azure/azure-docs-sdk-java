...
* Example: `# Azure Batch client library for Python - Version 1.2.0-beta.1 
`
...
https://github.com/Azure/azure-sdk-for-java/blob/azure-sdk-template_1.2.0-beta.1/sdk/appconfiguration/ci.yml
