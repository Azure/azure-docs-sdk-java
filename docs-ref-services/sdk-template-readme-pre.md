...
keywords: Azure, java, SDK, API, azure-sdk-template, templatetemplatetemplate
author: maggiepint
ms.author: magpint
ms.date: 11/05/2020
ms.topic: article
...
ms.technology: azure
ms.devlang: java
ms.service: templatetemplatetemplate
---
...
* Example: `# Azure Batch client library for Python - Version 1.2.1-beta.36 
`
