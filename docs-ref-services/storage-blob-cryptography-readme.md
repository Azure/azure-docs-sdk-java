---
title: Azure Storage Blob Cryptography for Java Readme
description: Azure storage blob cryptography provides classes for working with data in blob storage
author: maggiepint
ms.author: magpint
ms.date: 03/16/2020
ms.topic: conceptual
