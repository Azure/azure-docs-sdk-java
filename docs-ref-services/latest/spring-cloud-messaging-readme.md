...
# Azure Spring Cloud Messaging client library for Java - Version 2.7.0 
...
[environment_checklist]: https://github.com/Azure/azure-sdk-for-java/blob/azure-spring-cloud-messaging_2.7.0/sdk/spring/ENVIRONMENT_CHECKLIST.md#ready-to-run-checklist
