...
# Azure Core Management client library for Java - Version 1.3.1 
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-management_1.3.1/CONTRIBUTING.md).
