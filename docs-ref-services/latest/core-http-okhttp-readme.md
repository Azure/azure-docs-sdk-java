...
# Azure Core OkHttp HTTP plugin library for Java - Version 1.6.2 
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-http-okhttp_1.6.2/CONTRIBUTING.md).
