...
ms.service: core
---
# Azure Core OkHttp HTTP plugin library for Java - version 1.12.4 
...
To learn more about the BOM, see the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-http-okhttp_1.12.4/sdk/boms/azure-sdk-bom/README.md).
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-http-okhttp_1.12.4/CONTRIBUTING.md).
