---
title: Azure Spring cloud azure feature management client library for Java
...
# Azure Spring cloud azure feature management client library for Java - Version 1.2.8 
