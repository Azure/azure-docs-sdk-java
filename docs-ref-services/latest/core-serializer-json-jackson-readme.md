...
# Azure Core Jackson JSON Serializer plugin library for Java - Version 1.2.3 
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-serializer-json-jackson_1.2.3/CONTRIBUTING.md).
