...
ms.service: core
---
# Azure Core Jackson JSON Serializer plugin library for Java - version 1.4.7 
...
To learn more about the BOM, see the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-serializer-json-jackson_1.4.7/sdk/boms/azure-sdk-bom/README.md).
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-serializer-json-jackson_1.4.7/CONTRIBUTING.md).
