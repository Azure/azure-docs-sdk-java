...
---
# Azure Communication Service Common client library for Java - version 1.2.10 
...
To learn more about the BOM, see the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-communication-common_1.2.10/sdk/boms/azure-sdk-bom/README.md).
