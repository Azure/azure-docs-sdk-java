...
# Azure Spring Boot Starters client library for Java - Version 3.7.0 
...
Please follow [instructions here](https://github.com/Azure/azure-sdk-for-java/blob/azure-spring-boot-starter_3.7.0/sdk/spring/CONTRIBUTING.md) to build from source or contribute.
...
[environment_checklist]: https://github.com/Azure/azure-sdk-for-java/blob/azure-spring-boot-starter_3.7.0/sdk/spring/ENVIRONMENT_CHECKLIST.md#ready-to-run-checklist
[Add azure-spring-boot-bom]: https://github.com/Azure/azure-sdk-for-java/blob/azure-spring-boot-starter_3.7.0/sdk/spring/AZURE_SPRING_BOMS_USAGE.md#add-azure-spring-boot-bom
