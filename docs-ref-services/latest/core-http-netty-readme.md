---
description: Learn how to use the Azure Core Netty HTTP client plugin.
...
---
# Azure Core Netty HTTP plugin library for Java - Version 1.11.9 
...
To learn more about the BOM, see the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-http-netty_1.11.9/sdk/boms/azure-sdk-bom/README.md).
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-http-netty_1.11.9/CONTRIBUTING.md).
