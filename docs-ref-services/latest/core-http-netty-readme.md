...
# Azure Core Netty HTTP plugin library for Java - Version 1.8.0 
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-http-netty_1.8.0/CONTRIBUTING.md).
