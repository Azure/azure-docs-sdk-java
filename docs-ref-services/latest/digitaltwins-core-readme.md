...
description: This library provides access to the Azure Digital Twins service for managing twins, models, relationships, and more.
...
---
# Azure IoT Digital Twins client library for Java - Version 1.2.1 
...
To learn more about the BOM, see the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-digitaltwins-core_1.2.1/sdk/boms/azure-sdk-bom/README.md).
...
You can familiarize yourself with different APIs using [samples for Digital Twins](https://github.com/Azure/azure-sdk-for-java/tree/azure-digitaltwins-core_1.2.1/sdk/digitaltwins/azure-digitaltwins-core/src/samples).

## Source code folder structure

### /src/main/java/com/azure/digitaltwins/core

- The Digital Twins client builder [`DigitalTwinsClientBuilder`](https://github.com/Azure/azure-sdk-for-java/blob/azure-digitaltwins-core_1.2.1/sdk/digitaltwins/azure-digitaltwins-core/src/main/java/com/azure/digitaltwins/core/DigitalTwinsClientBuilder.java)
...
- [`models` package](https://github.com/Azure/azure-sdk-for-java/tree/azure-digitaltwins-core_1.2.1/sdk/digitaltwins/azure-digitaltwins-core/src/main/java/com/azure/digitaltwins/core/models)
...
To regenerate the code, run the Powershell script [generate.ps1](https://github.com/Azure/azure-sdk-for-java/blob/azure-digitaltwins-core_1.2.1/sdk/digitaltwins/azure-digitaltwins-core/generate.ps1).

### /src/samples

This directory contains sample code that demonstrates basic usage of this client library. For additional information, 
see the [sample readme](https://github.com/Azure/azure-sdk-for-java/blob/azure-digitaltwins-core_1.2.1/sdk/digitaltwins/azure-digitaltwins-core/src/samples/README.md)
...
See implementation examples with our [code samples](https://github.com/Azure/azure-sdk-for-java/tree/azure-digitaltwins-core_1.2.1/sdk/digitaltwins/azure-digitaltwins-core/src/samples).
...
[source]: https://github.com/Azure/azure-sdk-for-java/tree/azure-digitaltwins-core_1.2.1/sdk/digitaltwins/azure-digitaltwins-core
...
[token_credential]: https://docs.microsoft.com/java/api/com.azure.core.credential.tokencredential?view=azure-java-stable&preserve-view=true
...
[iot_cli_doc]: https://docs.microsoft.com/cli/azure/ext/azure-iot/dt?view=azure-cli-latest&preserve-view=true
