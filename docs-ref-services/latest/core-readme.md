...
# Azure Core shared library for Java - Version 1.19.0 
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core_1.19.0/CONTRIBUTING.md).
