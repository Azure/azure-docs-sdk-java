...
ms.service: core
---
# Azure Core shared library for Java - version 1.44.0 
...
the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-core_1.44.0/sdk/boms/azure-sdk-bom/README.md).
...
the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core_1.44.0/CONTRIBUTING.md).
