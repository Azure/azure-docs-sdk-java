...
ms.service: core
---
# Azure Core shared library for Java - version 1.55.2 
...
the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-core_1.55.2/sdk/boms/azure-sdk-bom/README.md).
...
the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core_1.55.2/CONTRIBUTING.md).
