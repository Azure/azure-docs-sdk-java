...
description: Learn how to use Azure CosmosDB client library with a multi-model database service for operational and analytics workloads.
...
[jdk]: /java/azure/java-supported-jdk-runtime
