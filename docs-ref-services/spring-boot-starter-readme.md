...
keywords: Azure, java, SDK, API, azure-spring-boot-starter, 
author: maggiepint
ms.author: magpint
ms.date: 08/20/2020
ms.topic: article
...
# Azure Spring Boot Starters client library for Java - Version 2.3.4 
...
- [Key Vault Secrets](https://github.com/Azure/azure-sdk-for-java/tree/153c67f15274c7a9a6e650e1e150ebb97f7956ae/sdk/spring/azure-spring-boot-samples/azure-spring-boot-sample-keyvault-secrets)
