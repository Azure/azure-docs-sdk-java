---
title: Azure Metrics Spring Boot Starter client library for Java
keywords: Azure, java, SDK, API, azure-spring-boot-metrics-starter, 
author: maggiepint
ms.author: magpint
ms.date: 08/14/2020
ms.topic: article
...
# Azure Metrics Spring Boot Starter client library for Java - Version 2.3.3 
