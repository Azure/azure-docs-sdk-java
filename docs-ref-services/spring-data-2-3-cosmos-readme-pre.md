---
title: Azure Spring Data 2.3 Cosmos client library for Java
keywords: Azure, java, SDK, API, azure-spring-data-2-3-cosmos, 
author: maggiepint
ms.author: magpint
ms.date: 08/18/2020
ms.topic: article
...
# Azure Spring Data 2.3 Cosmos client library for Java - Version 3.0.0-beta.1 
