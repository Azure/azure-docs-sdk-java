...
This article demonstrates how to configure an application created with the Spring Boot Initializer to use [Apache Kafka] with Azure Event Hubs.
...
1. Specify the following options:
   ...
   * Add the **Web** dependency.
   ...
   > [!NOTE]
   >
   > The Spring Initializr uses the **Group** and **Artifact** names to create the package name; for example: *com.wintiptoys.kafka*.
   >
...
[IMG01]: ./media/configure-spring-boot-starter-java-app-kafka-binder-event-hub/create-event-hub-01.png
[IMG02]: ./media/configure-spring-boot-starter-java-app-kafka-binder-event-hub/create-event-hub-02.png
[IMG03]: ./media/configure-spring-boot-starter-java-app-kafka-binder-event-hub/create-event-hub-03.png
[IMG04]: ./media/configure-spring-boot-starter-java-app-kafka-binder-event-hub/create-event-hub-04.png
[IMG05]: ./media/configure-spring-boot-starter-java-app-kafka-binder-event-hub/create-event-hub-05.png
[IMG06]: ./media/configure-spring-boot-starter-java-app-kafka-binder-event-hub/create-event-hub-06.png
[IMG07]: ./media/configure-spring-boot-starter-java-app-kafka-binder-event-hub/create-event-hub-07.png
[IMG08]: ./media/configure-spring-boot-starter-java-app-kafka-binder-event-hub/create-event-hub-08.png

[SI01]: ./media/configure-spring-boot-starter-java-app-kafka-binder-event-hub/create-project-01.png
[SI02]: ./media/configure-spring-boot-starter-java-app-kafka-binder-event-hub/create-project-02.png
[SI03]: ./media/configure-spring-boot-starter-java-app-kafka-binder-event-hub/create-project-03.png
