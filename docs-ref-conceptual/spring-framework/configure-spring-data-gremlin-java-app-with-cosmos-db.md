...
* [Introduction to Azure Cosmos DB: Graph API](https://docs.microsoft.com/azure/cosmos-db/graph-introduction)

* [Azure Cosmos DB Gremlin graph support](https://docs.microsoft.com/azure/cosmos-db/gremlin-support)
...
* [Tutorial: Query Azure Cosmos DB Graph API by using Gremlin](https://docs.microsoft.com/azure/cosmos-db/tutorial-query-graph)
