...
## Configure and complie your Spring Boot application
...
|---|---|
| Blob Storage | https://docs.microsoft.com/azure/storage/blobs/storage-java-how-to-use-blob-storage |
| Queue Storage | https://docs.microsoft.com/azure/storage/queues/storage-java-how-to-use-queue-storage |
| Table Storage | https://docs.microsoft.com/azure/cosmos-db/table-storage-how-to-use-java |
| File Storage | https://docs.microsoft.com/azure/storage/files/storage-java-how-to-use-file-storage |
