...
In this tutorial you learned how to clone a sample Spring Boot application that uses Cosmos DB for data and deploy it to Azure Container Service using the Fabric8 Maven Plugin.
