...
- 100% open source builds of OpenJDK that are packaged as Java Development Kits (JDKs), Java Runtime Environments (JREs), and Headless JREs. These binaries are fully compatible and compliant commercial builds of Java SE that can be used with Java application or Java components on Azure and Azure Stack.
- Provided with long-term support that includes bug fixes, performance enhancements, and security patches.
...
1. Backed and supported by Microsoft and Azul Systems
    - Zulu binaries are production ready and backed by Microsoft and Azul Systems
    - Zulu comes with zero cost long term support (LTS) for Java 7, 8, 11, and 17 in the future. You can upgrade Java versions only when you need to.
...
2. Production ready
    - Zulu is 100% open source builds of OpenJDK
    - It is a drop in replacement for many Java SE distributions
      - JDK, JRE, and JRE-headless
      - Java 7, 8, and 11
    - Zulu is verified compliant with the Java Standard Edition (Java SE) specifications using the OpenJDK Community Technology Compatibility Kit (TCK)
...
3. Multi-platform support
   - Zulu supports multiple platforms and versions
   - Windows Client
     - 10
     - 10 IoT Core
     - 8.1
   ...
   - Linux, including
     ...
     - Oracle Linux
   - Mac OS X
   - You can run Zulu on the server-side and client-side for dev, test, and production, as well as on your local machine for development and testing.
   - Zulu binaries are delivered in multiple package types
...
4. No cost
   - Microsoft provides everything you need to build and scale Java apps on Azure at no cost to you. Through Zulu you'll receive free seurity updates and platform bug fixes for Java apps without any fees.
...
6. Changes to Open JDK are up streamed
   - Azul Systems committers do upstream Zulu changes to OpenJDK which makes the upstream repo comprehensive and inclusive
